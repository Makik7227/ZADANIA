...
public class EmployeeProjectDao {
    ...
    public void saveHours(Integer EmpId, EmployeeAssigned employeeAssigned, Integer idProj) {
        jdbcTemplate.update(
                "UPDATE public.employee_projects SET hours=hours+? WHERE employee_id=? and project_id=?;", employeeAssigned.getHours(), EmpId, idProj);
    }
